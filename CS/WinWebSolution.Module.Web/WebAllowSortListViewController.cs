            ...
            if (gridListEditor != null) {
                ...
                if (allowSortListView) {
                    foreach (GridViewColumn column in gridListEditor.Grid.Columns) {
                        ...
                        if (dataColumn != null) {
                            dataColumn.Settings.AllowSort = dataColumn.Info.Node.GetAttributeBoolValue(AllowSortAttribute.AllowSortAttributeName)? DefaultBoolean.True: DefaultBoolean.False;
                        }
                    }
                }
            }
