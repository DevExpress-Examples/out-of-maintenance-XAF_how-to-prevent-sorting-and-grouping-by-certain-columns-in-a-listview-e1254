...
namespace WinWebSolution.Module {
    ...
    public abstract class AllowSortListViewController : ViewController<ListView> {
        ...
        protected bool GetAllowSortListView() {
            if (View.Model != null) {
                return ((IModelListViewAllowSort)View.Model).AllowSort;
            }
            return false;
        }
        protected bool GetAllowSortColumn(IModelColumn column) {
            if (column != null && GetAllowSortListView()) {
                return ((IModelColumnAllowSort)column).AllowSort;
            }
            return false;
        }
        protected override void OnActivated() {
            base.OnActivated();
            View.ModelChanged += new EventHandler(ListView_InfoChanged);
        }
